...
#
# Created: Sun Nov 13 04:03:51 2016
...
class Ui_mmqgis_geocode_street_layer_form(object):
    def setupUi(self, mmqgis_geocode_street_layer_form):
        ...
        self.label_20 = QtGui.QLabel(mmqgis_geocode_street_layer_form)
        self.label_20.setGeometry(QtCore.QRect(10, 280, 141, 22))
        self.label_20.setObjectName(_fromUtf8("label_20"))
        self.aeiou_qual = QtGui.QComboBox(mmqgis_geocode_street_layer_form)
        self.aeiou_qual.setGeometry(QtCore.QRect(10, 300, 111, 27))
        self.aeiou_qual.setObjectName(_fromUtf8("aeiou_qual"))
        self.aeiou_qual.addItem(_fromUtf8(""))
        self.aeiou_qual.addItem(_fromUtf8(""))
        self.aeiou_qual.addItem(_fromUtf8(""))
        self.aeiou_qual.addItem(_fromUtf8(""))
        self.aeiou_qual.addItem(_fromUtf8(""))
        self.zip_allowance = QtGui.QCheckBox(mmqgis_geocode_street_layer_form)
        self.zip_allowance.setGeometry(QtCore.QRect(10, 340, 131, 21))
        self.zip_allowance.setObjectName(_fromUtf8("zip_allowance"))
        self.nr_allowance = QtGui.QCheckBox(mmqgis_geocode_street_layer_form)
        self.nr_allowance.setGeometry(QtCore.QRect(10, 370, 130, 21))
        self.nr_allowance.setObjectName(_fromUtf8("nr_allowance"))
    ...
    def retranslateUi(self, mmqgis_geocode_street_layer_form):
        ...
        self.label_20.setText(QtGui.QApplication.translate("mmqgis_geocode_street_layer_form", "Address match quality", None, QtGui.QApplication.UnicodeUTF8))
        self.aeiou_qual.setItemText(0, QtGui.QApplication.translate("mmqgis_geocode_street_layer_form", "1", None, QtGui.QApplication.UnicodeUTF8))
        self.aeiou_qual.setItemText(1, QtGui.QApplication.translate("mmqgis_geocode_street_layer_form", "2", None, QtGui.QApplication.UnicodeUTF8))
        self.aeiou_qual.setItemText(2, QtGui.QApplication.translate("mmqgis_geocode_street_layer_form", "3", None, QtGui.QApplication.UnicodeUTF8))
        self.aeiou_qual.setItemText(3, QtGui.QApplication.translate("mmqgis_geocode_street_layer_form", "4", None, QtGui.QApplication.UnicodeUTF8))
        self.aeiou_qual.setItemText(4, QtGui.QApplication.translate("mmqgis_geocode_street_layer_form", "5", None, QtGui.QApplication.UnicodeUTF8))
        self.zip_allowance.setText(QtGui.QApplication.translate("mmqgis_geocode_street_layer_form", "Allowance for post\n"
"code alterations", None, QtGui.QApplication.UnicodeUTF8))
        self.nr_allowance.setText(QtGui.QApplication.translate("mmqgis_geocode_street_layer_form", "Allowance for uncoded\n"
"house numbers", None, QtGui.QApplication.UnicodeUTF8))
